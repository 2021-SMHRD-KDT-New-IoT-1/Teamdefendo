      ...
      <div class="menu_inner menu_mm">
         <div class="menu menu_mm">
            <ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="All_Worker.jsp">직원 통합 관리</a></li>
					<li class="menu_item menu_mm"><a href="Location.jsp">직원 위치 확인</a></li>
					<li class="menu_item menu_mm"><a href="machine.html">기기등록</a></li>
					<li class="menu_item menu_mm"><a href="../Logout">로그아웃</a></li>
            </ul>
